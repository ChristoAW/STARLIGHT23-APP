...
import { Heado } from '@/components/pages/about-us/styles';
import { SubHeadBody, SubSubHeadBody } from '@/components/pages/about-us/texts';

import {
  LogoStarlight,
  TitleStarlight,
} from '@/components/pages/about-us/images';
  ...
  return (
    ...
    >
      ...
      <SubSubHeadBody
        ...
        body={
          <>
            Lautan luas yang memiliki berbagai cahaya di dalamnya untuk membuat
            lautan tersebut bersinar. Dimulai dengan percikan (bakat) yang
            memerlukan proses pencarian panjang dalam kehidupan kita untuk siap
            bersinar. Siapkah kamu mengarungi lautan luas untuk memancarkan
            cahaya terbaikmu?
          </>
        }
      />
      <SubSubHeadBody
        ...
        body={
          <>
            Starlight 2023 mengusung tema Journey of The Voyagers yang memiliki
            makna sebuah perjalanan dari pengembara atau penjelajah. Kita
            meyakini setiap individu memerlukan sebuah proses yang panjang dalam
            menemukan bakat yang mereka miliki sampai akhirnya bakat itu dapat
            menjadi ciri khas serta berdampak bagi sekitarnya.
          </>
        }
      />
      <SubSubHeadBody
